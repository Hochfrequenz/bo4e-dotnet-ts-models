...
export type Angebotsteil = {
  ...
  positionen: Angebotsposition[] | null;
  lieferzeitraum: Zeitraum;
  lieferstellen?: BusinessObject[] | null;
  [k: string]: unknown;
} & Angebotsteil1;
...
export type Geokoordinaten = {
  ...
  oestlicheLaenge: number | null;
  noerdlicheBreite: number | null;
  zone: string | null;
  nordWert: string | null;
  ostWert: string | null;
  timestamp?: string | null;
  guid?: string | null;
  [k: string]: unknown;
...
export type Netznutzungsabrechnungsdaten = {
  ...
  zaehlzeit: Zaehlzeitregister;
  istDifferenz: boolean | null;
  marktrollen: MarktpartnerDetails[] | null;
  [k: string]: unknown;
...
export type Angebotsposition = {
  timestamp?: string | null;
  guid?: string | null;
  positionsbezeichung: string | null;
  ...
  artikelId: string | null;
  positionsmengeMinimum: Menge;
  positionsmengeMaximum: Menge;
  [k: string]: unknown;
} & Angebotsposition1;
...
export interface Angebot {
  ...
  unterzeichnerAngebotsgeber: Ansprechpartner;
  varianten: Angebotsvariante[] | null;
  gueltigkeitszeitraum?: Zeitraum;
  qualitaet?:
    null | "VOLLSTAENDIG" | "INFORMATIV" | "IM_SYSTEM_VORHANDEN" | "ERWARTET" | "VORLAEUFIG" | "UNVOLLSTAENDIG";
  [k: string]: unknown;
